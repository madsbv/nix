...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "madsbv"
    user-mail-address "mbvilladsen@pm.me")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/mvilladsen/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/mvilladsen/bin" "/profile/bin" "/Users/mvilladsen/.npm-packages/bin" "/Users/mvilladsen/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
